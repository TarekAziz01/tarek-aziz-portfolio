      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row ">
          ...
          <div className="flex-1 lg:bg-services lg:bg-bottom bg-no-repeat mix-blend-lighten mb-12 lg:mb-0 ">
            ...
            <h3 className="text-white font-primary font-semibold text-[26px] leading-[46px] max-w-[455px] mb-16">
                ...
                return (
                  ...
                  >
                    <div className="max-w-[476px]">
                      <h4 className="text-white text-[24px] tracking-wider font-primary font-semibold mb-6">
                        {name}
                      </h4>
                    ...
                    <div className="flex flex-col flex-1 items-end">
                      ...
                      <a
                        href=" #"
                        className="bg-gradient-to-r text-transparent bg-clip-text from-[#42A6E3] to-[#FF56F6] font-bold font-primary hover:from-[#FF56F6] hover:to-[#42A6E3] text-lg"
                      >
                        {link}
                      </a>
                    </div>
